...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
	...
	HOENN_TO_NATIONAL(POTATER),
	HOENN_TO_NATIONAL(BAKETATER),
	HOENN_TO_NATIONAL(TOXITATER),
	...
	HOENN_TO_NATIONAL(SARDEE),
	HOENN_TO_NATIONAL(TUNAVA),
	HOENN_TO_NATIONAL(SALMIN),
	...
	HOENN_TO_NATIONAL(CLIFF_RACER),
	HOENN_TO_NATIONAL(SILT_STRIDER),
	HOENN_TO_NATIONAL(FIREATRONACH),
	HOENN_TO_NATIONAL(COLDATRONACH),
	HOENN_TO_NATIONAL(BOLTATRONACH),
	HOENN_TO_NATIONAL(LAPRAS),
	HOENN_TO_NATIONAL(SNORLAX),
	HOENN_TO_NATIONAL(GELATIN_CUBE),
	HOENN_TO_NATIONAL(BEHOLDER),
	HOENN_TO_NATIONAL(TRINEXX),
	HOENN_TO_NATIONAL(GUARDIAN),
	HOENN_TO_NATIONAL(FLUXTRUCT),
	HOENN_TO_NATIONAL(ROBOKONE),
	HOENN_TO_NATIONAL(CAKETANK),
	...
	HOENN_TO_NATIONAL(KERNEL_PULT),
	HOENN_TO_NATIONAL(CARAMEL_CORN),
	HOENN_TO_NATIONAL(COB_CANNON),
	HOENN_TO_NATIONAL(DWERACHNID),
	HOENN_TO_NATIONAL(DWEMERORB),
	HOENN_TO_NATIONAL(DWENTURION),
	HOENN_TO_NATIONAL(PLEISTO_GIFT),
	HOENN_TO_NATIONAL(IRON_VALIANT),
	HOENN_TO_NATIONAL(FROZEN_NECK),
	HOENN_TO_NATIONAL(HILAND_STEED),
	HOENN_TO_NATIONAL(IRON_EQUINE),
	HOENN_TO_NATIONAL(ULTRAMAGUS),
	HOENN_TO_NATIONAL(INFRABLADE),
	HOENN_TO_NATIONAL(VISYBILITE),
	HOENN_TO_NATIONAL(SARIMANOK),
	HOENN_TO_NATIONAL(ARTICUNO),
	HOENN_TO_NATIONAL(ZAPDOS),
	HOENN_TO_NATIONAL(MOLTRES),
	HOENN_TO_NATIONAL(PLUBOMBOS),
	HOENN_TO_NATIONAL(JUPETHER),
	HOENN_TO_NATIONAL(NEPQUAKE),
	HOENN_TO_NATIONAL(VAH_RUTA),
	HOENN_TO_NATIONAL(VAH_RUDANIA),
	HOENN_TO_NATIONAL(VAH_NABORIS),
	HOENN_TO_NATIONAL(VAH_MEDOH),
	HOENN_TO_NATIONAL(MEWTWO),
	HOENN_TO_NATIONAL(WARMECH),
	HOENN_TO_NATIONAL(REGIFUSION),
};
