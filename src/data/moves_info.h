...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_FLARE_BLITZ] =
    {
        ...
        .description = COMPOUND_STRING(
            "A reckless charge that\n"
            "hurts the user. 10% Burn"),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_AUTOTOMIZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Sheds additional weight,\n"
            "sharply boosting Speed."),
