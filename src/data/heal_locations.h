static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EASTFORD - 1] = {MAP_GROUP(EASTFORD_OW), MAP_NUM(EASTFORD_OW), 25, 27},
    [HEAL_LOCATION_KIRKOPOLIS - 1] = {MAP_GROUP(KIRKOPOLIS_OW), MAP_NUM(KIRKOPOLIS_OW), 12, 19},
    ...
    [HEAL_LOCATION_SOUTHPORT - 1] = {MAP_GROUP(SOUTHPORT_OW), MAP_NUM(SOUTHPORT_OW), 11, 10},
};
