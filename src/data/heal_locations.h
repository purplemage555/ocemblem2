static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EASTFORD - 1] = {MAP_GROUP(EASTFORD_OW), MAP_NUM(EASTFORD_OW), 27, 25},
    ...
    [HEAL_LOCATION_RADIO_OUTPOST - 1] = {MAP_GROUP(RADIO_OUTPOST), MAP_NUM(RADIO_OUTPOST), 92, 7},
