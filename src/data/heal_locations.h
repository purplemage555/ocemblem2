static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EASTFORD - 1] = {MAP_GROUP(EASTFORD_OW), MAP_NUM(EASTFORD_OW), 27, 29},
    [HEAL_LOCATION_KIRKOPOLIS - 1] = {MAP_GROUP(KIRKOPOLIS_OW), MAP_NUM(KIRKOPOLIS_OW), 12, 17},
    [HEAL_LOCATION_PETESBURG - 1] = {MAP_GROUP(PETESBURG_OW), MAP_NUM(PETESBURG_OW), 12, 16},
    [HEAL_LOCATION_SANCTUM - 1] = {MAP_GROUP(SANCTUM_OW), MAP_NUM(SANCTUM_OW), 18, 7},
    [HEAL_LOCATION_TARIF - 1] = {MAP_GROUP(FORT_TARIF), MAP_NUM(FORT_TARIF), 7, 26},
    [HEAL_LOCATION_SOUTHPORT - 1] = {MAP_GROUP(SOUTHPORT_OW), MAP_NUM(SOUTHPORT_OW), 12, 10},
    [HEAL_LOCATION_CRASHSITE - 1] = {MAP_GROUP(ALIEN_CRASH_SITE), MAP_NUM(ALIEN_CRASH_SITE), 23, 22},
    [HEAL_LOCATION_RADIO_OUTPOST - 1] = {MAP_GROUP(RADIO_OUTPOST), MAP_NUM(RADIO_OUTPOST), 71, 12},
    [HEAL_LOCATION_NOVEMBURG - 1] = {MAP_GROUP(NOVEMBURG_OW), MAP_NUM(NOVEMBURG_OW), 26, 31},
    [HEAL_LOCATION_EBONHEART - 1] = {MAP_GROUP(NEW_EBONHEART_OW), MAP_NUM(NEW_EBONHEART_OW), 35, 10},
    [HEAL_LOCATION_AGRIOPOLIS - 1] = {MAP_GROUP(AGRIOPOLIS_OW), MAP_NUM(AGRIOPOLIS_OW), 11, 33},
};
