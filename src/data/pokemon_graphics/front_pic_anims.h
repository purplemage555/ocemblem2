...
static const union AnimCmd sAnim_FrozenNeck_1[] =
{
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_END,
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Ultramagus);
PLACEHOLDER_ANIM_SINGLE_FRAME(Infrablade);
PLACEHOLDER_ANIM_SINGLE_FRAME(Visybilite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Potater);
PLACEHOLDER_ANIM_SINGLE_FRAME(Baketater);
PLACEHOLDER_ANIM_SINGLE_FRAME(Toxitater);
PLACEHOLDER_ANIM_SINGLE_FRAME(KernelPult);
PLACEHOLDER_ANIM_SINGLE_FRAME(CaramelCorn);
PLACEHOLDER_ANIM_SINGLE_FRAME(CobCannon);
PLACEHOLDER_ANIM_SINGLE_FRAME(GelatinCube);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vehicloth);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sardee);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tunava);
PLACEHOLDER_ANIM_SINGLE_FRAME(Salmin);
...
#endif //P_FAMILY_PECHARUNT
SINGLE_ANIMATION(Ultramagus);
SINGLE_ANIMATION(Infrablade);
SINGLE_ANIMATION(Visybilite);
SINGLE_ANIMATION(Potater);
SINGLE_ANIMATION(Baketater);
SINGLE_ANIMATION(Toxitater);
SINGLE_ANIMATION(KernelPult);
SINGLE_ANIMATION(CaramelCorn);
SINGLE_ANIMATION(CobCannon);
SINGLE_ANIMATION(GelatinCube);
SINGLE_ANIMATION(Vehicloth);
SINGLE_ANIMATION(Sardee);
SINGLE_ANIMATION(Tunava);
SINGLE_ANIMATION(Salmin);
