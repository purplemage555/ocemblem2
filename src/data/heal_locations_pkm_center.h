...
static const struct HealLocation sHealLocationsPokemonCenter[HEAL_LOCATION_COUNT - 1] =
{
	...
	[HEAL_LOCATION_EASTFORD - 1] =
    {
        .group = MAP_GROUP(EASTFORD_POKE_CENTER),
        .map = MAP_NUM(EASTFORD_POKE_CENTER),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
	[HEAL_LOCATION_KIRKOPOLIS - 1] =
    {
        .group = MAP_GROUP(KIRKOPOLIS_POKE_CENTER),
        .map = MAP_NUM(KIRKOPOLIS_POKE_CENTER),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
	[HEAL_LOCATION_PETESBURG - 1] =
    {
        .group = MAP_GROUP(PETESBURG_POKE_CENTER),
        .map = MAP_NUM(PETESBURG_POKE_CENTER),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
	[HEAL_LOCATION_SANCTUM - 1] =
    {
        .group = MAP_GROUP(SANCTUM_POKE_CENTER),
