...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_NIDORAN_F] =
    {
        ...
        .abilities = { ABILITY_POISON_POINT, ABILITY_HUSTLE, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .description = COMPOUND_STRING(
            ...
            "Pokémon. When enraged, it releases toxins\n"
            "from its horn. 55/47/52/40/40/41"),
        .pokemonScale = 488,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .teachableLearnset = sNidoTeachableLearnset,
    ...
    [SPECIES_NIDORINA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "prevent injury. It gets nervous when\n"
            "away from them. 70/62/67/55/55/56"),
        .pokemonScale = 381,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .categoryName = _("Drill Queen"),
        .height = 13,
        .weight = 600,
        .description = COMPOUND_STRING(
            "It sends foes flying with harsh tackles\n"
            "using its tough, scaly body. This Pokémon\n"
            "is at its strongest when defending its\n"
            "young. 90/92/87/85/85/76"),
        .pokemonScale = 293,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "this Pokémon's notice. 46/57/40/42/40/50"),
        .pokemonScale = 511,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .weight = 195,
        .description = COMPOUND_STRING(
            "Its horn is harder than diamond. If it\n"
            "senses hostiles, all the barbs on its back\n"
            "bristle up at once, and it challenges foes\n"
            "with all its might. 61/72/57/55/55/65"),
        .pokemonScale = 408,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .categoryName = _("Drill King"),
        .height = 14,
        .weight = 620,
        .description = COMPOUND_STRING(
            "Its thick tail packs destructive power\n"
            "capable of toppling transmission towers.\n"
            "Once it goes on a rampage, there is no\n"
            "stopping it. 81/102/77/95/75/85"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .weight = 99,
        .description = COMPOUND_STRING(
            "It can freely control fire, making\n"
            "fiery orbs like will-o'-the-wisps.\n"
            "Just before evolution, its six tails\n"
            "become fiery-hot. 39/41/40/65/65/65"),
        .pokemonScale = 542,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .weight = 199,
        .description = COMPOUND_STRING(
            "Ninetales can conjure sunlight even\n"
            "in the dead of night or harsh storms.\n"
            "A long-lived Ninetales will have fur that\n"
            "shines like gold. 73/76/75/91/100/100"),
        .pokemonScale = 339,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "eyes gradually grew shut, depriving them\n"
            "of vision. They use echolocation to detect\n"
            "obstacles and threats. 40/45/35/30/40/55"),
        .pokemonScale = 362,
        .pokemonOffset = -5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
            "Its fangs easily pierce even thick hides.\n"
            "It loves to feast on the blood of people\n"
            "and Pokémon. It flits about in darkness,\n"
            "lunging from behind. 75/80/70/65/75/90"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "without stopping. 85/90/80/70/80/130"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 281,
        .trainerOffset = 1,
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to spot even tiny prey. 60/40/50/55/55/45"),
        .pokemonScale = 360,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = -1,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Venomoth are nocturnal. Their favorite\n"
            "prey are insects that gather around\n"
            "streetlights, attracted by the light\n"
            "in the darkness. 70/45/60/100/75/100"),
        .pokemonScale = 285,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 1,
        ...
        .teachableLearnset = sVenonatTeachableLearnset,
		.evolutions = EVOLUTION({EVO_ITEM, ITEM_DRAGON_SCALE, SPECIES_VEHICLOTH}),
    },
	[SPECIES_VEHICLOTH] =
    {
        .baseHP        = 80,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ALL_TERRAIN, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Vehicloth"),
        .cryId = CRY_VENOMOTH,
        .natDexNum = NATIONAL_DEX_VEHICLOTH,
        .categoryName = _("All-Terrain"),
        .height = 15,
        .weight = 125,
        .description = COMPOUND_STRING(
            "Legends tell of a feeble Venomoth which\n"
            "defeated a mighty Dragonite. Those who\n"
            "prove to be worthy of its legacy evolve\n"
            "into Vehicloth. 80/50/70/125/90/125"),
        .pokemonScale = 285,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_Vehicloth,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_Venomoth,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .enemyMonElevation = 0,
        .backPic = gMonBackPic_Vehicloth,
        .backPicSize = MON_COORDS_SIZE(56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
        .palette = gMonPalette_Vehicloth,
        .shinyPalette = gMonPalette_Vehicloth,
        .iconSprite = gMonIcon_Venomoth,
        .iconPalIndex = 2,
        SHADOW(-5, 18, SHADOW_SIZE_M)
        FOOTPRINT(Venomoth)
		...
		.perfectIVCount = LEGENDARY_PERFECT_IV_COUNT,
        .levelUpLearnset = sVehiclothLevelUpLearnset,
        .teachableLearnset = sVehiclothTeachableLearnset,
    },
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "because wherever they dig, the soil\n"
            "becomes perfectly tilled for growing\n"
            "tasty crops. 20/55/30/35/45/95"),
        .pokemonScale = 833,
        .pokemonOffset = 25,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "This Pokémon loves shiny coins.\n"
            "40/65/35/50/40/90"),
        .pokemonScale = 480,
        .pokemonOffset = 19,
        .trainerScale = 256,
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "by the whiskers. 64/88/60/88/65/115"),
        .pokemonScale = 320,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .weight = 195,
        .description = COMPOUND_STRING(
            "This Pokémon sleeps 18 hours a day.\n"
            "Agamotto, the first Sorcerer Supreme,\n"
            "befriended an Abra which became his\n"
            "trusted familiar. 25/20/15/105/55/90"),
        .pokemonScale = 363,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "into psionics. 40/35/30/120/75/105"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "are very weak. It moves using psionics\n"
            "and loves ice cream. 55/50/45/135/95/120"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SKILL_LINK, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Bellsprout"),
        .cryId = CRY_BELLSPROUT,
        .natDexNum = NATIONAL_DEX_BELLSPROUT,
        .categoryName = _("Peashooter"),
        .height = 7,
        .weight = 40,
        .description = COMPOUND_STRING(
            "A Bellsprout's thin and flexible body lets\n"
            "it bend and sway to avoid any attack,\n"
            "however strong it may be. Its acid melts\n"
            "even plastic and metal. 50/75/35/70/30/40"),
        .pokemonScale = 354,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "wake up on the ground. 65/90/50/85/45/55"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .categoryName = _("Chomper"),
        .height = 17,
        .weight = 155,
        .description = COMPOUND_STRING(
            "The long vine extending from its head is\n"
            "waved about as if it were a living thing\n"
            "to attract prey. It swallows prey whole\n"
            "once it approaches. 80/105/65/100/80/70"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 312,
        .trainerOffset = 3,
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "stingers at their tips. 40/40/35/75/100/70"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the ocean floor and traps prey using\n"
            "its 80 tentacles. Its red orbs glow when\n"
            "excited or angry. 80/70/65/100/120/100"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 312,
        .trainerOffset = 1,
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "like boulders, hikers often step on them\n"
            "without noticing. 40/80/100/30/30/20"),
        .pokemonScale = 347,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        .weight = 1050,
        .description = COMPOUND_STRING(
            "They descend from mountains by rolling\n"
            "down steep slopes. They are so brutal,\n"
            "they smash trees and boulders just like\n"
            "bowling balls. 55/95/115/45/55/35"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "returns to the soil. 85/120/130/55/65/45"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "forgets what it is doing and ends up just\n"
            "loafing around. 90/65/65/40/40/15"),
        .pokemonScale = 256,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_QUICK_DRAW, ABILITY_REGENERATOR, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .description = COMPOUND_STRING(
            ...
            "to actively hunt. 95/75/110/100/80/30"),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 296,
        .trainerOffset = 2,
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_CURIOUS_MEDICINE, ABILITY_REGENERATOR, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .description = COMPOUND_STRING(
            ...
            "However, it forgets everything if its\n"
            "crown comes off. 95/65/80/110/110/30"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 5,
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "over 100m away. 25/35/70/95/55/45"),
        .pokemonScale = 288,
        .pokemonOffset = -9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .categoryName = _("Tri-Magnet"),
        .height = 10,
        .weight = 600,
        .description = COMPOUND_STRING(
            "It is actually three Magnemite linked\n"
            "by magnetism. It generates powerful radio\n"
            "waves that raise temperatures by 2ºC\n"
            "within a 1km radius. 60/60/96/120/72/72"),
        .pokemonScale = 292,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAGNEZONE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its own signals. 70/70/115/130/90/60"),
        .pokemonScale = 282,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_STICKY_HOLD, ABILITY_REGENERATOR, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Grimer"),
        .cryId = CRY_GRIMER,
        .natDexNum = NATIONAL_DEX_GRIMER,
        .categoryName = _("Ube Sludge"),
        .height = 9,
        .weight = 300,
        .description = COMPOUND_STRING(
            "Born from industrial runoff, Grimer eats\n"
            "garbage and converts it into nutrients.\n"
            "Grimer native to Selenia have a sweet\n"
            "purple yam scent. 80/80/50/40/50/25"),
        .pokemonScale = 258,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MUK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "but doesn't mind cold and dry either.\n"
            "Muk can be quite fond of purple yam\n"
            "flavored sweets. 105/105/75/65/100/50"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SHELLDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "with its tongue out. 30/65/100/45/25/40"),
        .pokemonScale = 675,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLOYSTER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It uses the same system to shoot spiky\n"
            "icicles. 50/95/180/95/45/70"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 269,
        .trainerOffset = 1,
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to escape the wind. 30/35/30/100/35/80"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "This Pokémon will try to lick you and\n"
            "drain your energy. 45/50/45/115/55/95"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [SPECIES_GENGAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It is actually a Gengar pretending to\n"
            "be your shadow. 60/65/60/130/75/110"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 302,
        .trainerOffset = 2,
    ...
    [SPECIES_ONIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_WEAK_ARMOR, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "toward the earth's core, reaching depths\n"
            "of over 1km. 75/85/200/55/65/30."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 516,
        .trainerOffset = 13,
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "veterans take care. 40/30/50/55/55/100"),
        .pokemonScale = 364,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "chaotic blackouts. 60/50/70/80/80/150"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SUN_SOAK, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .description = COMPOUND_STRING(
            ...
            "spin around. When cracks appear, it is\n"
            "close to evolving. 60/40/80/60/45/40"),
        .pokemonScale = 489,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EXEGGUTOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sunlight. When the heads fall, they form\n"
            "into an Exeggcute. 95/105/85/125/75/55"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 5,
    ...
    [SPECIES_EXEGGUTOR_ALOLA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SUN_SOAK, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Exeggutor"),
        .cryId = CRY_EXEGGUTOR,
        .natDexNum = NATIONAL_DEX_EXEGGUTOR,
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "it tends to its legs. 50/120/78/35/110/102"),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 259,
        .trainerOffset = 1,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the world champion. It will never give up\n"
            "or let you down. 70/105/99/35/110/76"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 277,
        .trainerOffset = 2,
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "is a remarkable mix of both offense and\n"
            "defense. Hitmontop spin much faster\n"
            "than they walk. 50/90/90/35/110/120"),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "explodes when touched. 40/65/95/60/45/35"),
        .pokemonScale = 369,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEEZING] =
    {
        ...
        .categoryName = _("Toxic Gas"),
        .height = 12,
        .weight = 95,
        .description = COMPOUND_STRING(
            "By diluting its toxic gases with a special\n"
            "process, the highest grade of perfume can\n"
            "be extracted. To Weezing, toxic gases are\n"
            "the ultimate feast. 65/90/120/85/70/60"),
        .pokemonScale = 305,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_RECKLESS, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Rhyhorn"),
        .cryId = CRY_RHYHORN,
        .natDexNum = NATIONAL_DEX_RHYHORN,
        .categoryName = _("Spiked Rhino"),
        .height = 10,
        .weight = 1150,
        .description = COMPOUND_STRING(
            ...
            "the first place. 80/85/95/30/30/25"),
        .pokemonScale = 267,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_RHYDON}),
    },
    [SPECIES_RHYDON] =
    {
        .baseHP        = 105,
        ...
        .description = COMPOUND_STRING(
            ...
            "is well developed. 105/130/120/45/45/40"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 299,
        .trainerOffset = 2,
		...
		.levelUpLearnset = sRhyhornLevelUpLearnset,
        .teachableLearnset = sRhyhornTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_RHYPERIOR},
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_RECKLESS, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its severed limbs. 30/45/55/70/55/85"),
        .pokemonScale = 326,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "waves at night. 60/75/85/100/85/115"),
        .pokemonScale = 301,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "in one sharp stroke. 70/110/80/55/80/105"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sorts of attacks. It flaps its wings for\n"
            "thermal regulation. 70/130/100/55/80/65"),
        .pokemonScale = 278,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STAMINA, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
        .categoryName = _("Muffalo"),
        .height = 14,
        .weight = 884,
        .description = COMPOUND_STRING(
            ...
            "trees to calm itself. 85/100/105/70/70/110"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "easily washed away by currents. They\n"
            "often get stuck in stagnant waters.\n"
            "20/10/55/15/20/80"),
        .pokemonScale = 310,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the ground. 95/125/79/100/60/81"),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 481,
        .trainerOffset = 13,
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_RAIN_DISH, ABILITY_FILTER, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .weight = 2200,
        .description = COMPOUND_STRING(
            "Lapras once neared extinction due to\n"
            "poaching. After protective regulations\n"
            "and one youth's efforts, there are now\n"
            "plenty of them. 130/80/80/95/95/60"),
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_DITTO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "details wrong. 100/50/50/50/50/100"),
        .pokemonScale = 633,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "allow them to live underwater. They can\n"
            "control water. 130/65/60/110/95/65"),
        .pokemonScale = 316,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "electrically charged. 65/65/60/110/95/130"),
        .pokemonScale = 283,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "rise up to 900ºC. 65/130/60/110/95/65"),
        .pokemonScale = 306,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "said to have developed psionic powers to\n"
            "protect its Trainer. 65/65/60/130/95/110"),
        .pokemonScale = 363,
        .pokemonOffset = 14,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLACK,
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
            "Umbreon evolved from exposure to energy\n"
            "pulses from Masser and Secunda. It lurks\n"
            "in darkness and waits for enemy movement.\n"
            "95/65/110/60/130/65"),
        .pokemonScale = 317,
        .pokemonOffset = 11,
        .trainerScale = 256,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SUN_SOAK, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .description = COMPOUND_STRING(
            ...
            "photosynthesis to produce energy even\n"
            "without eating. 65/110/130/60/65/95"),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "diamond dust. 65/60/110/130/95/65"),
        .pokemonScale = 366,
        .pokemonOffset = 10,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "later, it pounces. 95/65/65/110/130/60"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TRACE, ABILITY_ANALYTIC, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .description = COMPOUND_STRING(
            ...
            "cyberspace. Its ROM data is encrypted\n"
            "to prevent piracy. 70/60/70/85/75/40"),
        .pokemonScale = 328,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PORYGON2] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "emotions on its own. 85/80/90/105/95/60"),
        .pokemonScale = 320,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .categoryName = _("Modded"),
        .height = 9,
        .weight = 340,
        .description = COMPOUND_STRING(
            "In order to create a more advanced\n"
            "Pokémon, an additional program was\n"
            "installed, but apparently that made\n"
            "it unstable. 85/80/70/135/75/90"),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SAND_RUSH, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Omanyte"),
        .cryId = CRY_OMANYTE,
        .natDexNum = NATIONAL_DEX_OMANYTE,
        .categoryName = _("Helix"),
        .height = 4,
        .weight = 75,
        .description = COMPOUND_STRING(
            "One of the ancient and long-since-extinct\n"
            "Pokémon that have been regenerated\n"
            "from fossils by humans. Some revere\n"
            "it as a god. 35/40/100/90/60/35"),
        .pokemonScale = 521,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "slowing it down. 75/60/125/115/95/55"),
        .pokemonScale = 307,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .categoryName = _("Amber"),
        .height = 18,
        .weight = 590,
        .description = COMPOUND_STRING(
            "Aerodactyl is a Pokémon from the age of\n"
            "dinosaurs. It was regenerated from DNA\n"
            "extracted from amber. It once lived with\n"
            "Mesozoic manaketes. 80/105/65/75/75/130"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 302,
        .trainerOffset = 4,
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "a docile Pokémon that children often play\n"
            "on its big belly. 160/110/65/65/110/30"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 423,
        .trainerOffset = 11,
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AIR_PRESSURE, ABILITY_NONE, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .description = COMPOUND_STRING(
            ...
            "chills the air. It also has psionic powers.\n"
            "90/85/100/125/125/95"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 2,
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AIR_PRESSURE, ABILITY_NONE, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .description = COMPOUND_STRING(
            ...
            "It has a top speed of 300km/h in the air\n"
            "and on land. 90/125/90/125/90/100"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 318,
        .trainerOffset = 3,
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AIR_PRESSURE, ABILITY_NONE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .description = COMPOUND_STRING(
            ...
            "that can control fire. If injured, it dips\n"
            "itself in a volcano to heal. Its wrath is\n"
            "excessively violent. 90/100/90/125/125/90"),
        .pokemonScale = 270,
        .pokemonOffset = 0,
        .trainerScale = 387,
        .trainerOffset = 8,
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "it is very aloof. 106/110/90/154/90/130"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
        .trainerOffset = 4,
