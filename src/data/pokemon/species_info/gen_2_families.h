...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .description = COMPOUND_STRING(
            ...
            "sunlight's reach. 75/38/38/56/56/67"),
        .pokemonScale = 424,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "people and Pokémon. It stores up joy in\n"
            "its shell to share. 35/20/65/40/70/20"),
        .pokemonScale = 507,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "joy with that person. 55/40/85/80/105/40"),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "days used its light to communicate from\n"
            "far away. 90/75/85/115/90/55"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_SAP_SIPPER, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .description = COMPOUND_STRING(
            ...
            "motions as well. 70/80/65/90/65/85"),
        .pokemonScale = 281,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sap of trees. Its shell is hard as steel.\n"
            "It is proud of its horn, which it rams\n"
            "into foes. 80/125/75/40/95/85"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "when it can. 55/95/55/35/75/115"),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "by coordinating. 70/120/65/45/85/125"),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ICE_BODY, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .description = COMPOUND_STRING(
            ...
            "against the ground. Its favorite food\n"
            "is truffles. It occasionally roots out\n"
            "hot springs. 50/50/40/30/30/50"),
        .pokemonScale = 324,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It uses its tusks to dig up food buried\n"
            "under ice. 100/100/80/60/60/50"),
        .pokemonScale = 306,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .levelUpLearnset = sSwinubLevelUpLearnset,
        .teachableLearnset = sSwinubTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_MAMOSWINE}, {EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE}),
    },
    [SPECIES_MAMOSWINE] =
    {
        .baseHP        = 110,
        ...
        .description = COMPOUND_STRING(
            ...
            "much awe. This Pokémon has existed since\n"
            "the Pleistocene. 110/130/80/70/60/85"),
        .pokemonScale = 257,
        .pokemonOffset = 6,
        .trainerScale = 423,
        .trainerOffset = 8,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .categoryName = _("Gun Fish"),
        .height = 6,
        .weight = 120,
        .description = COMPOUND_STRING(
            "A Remoraid uses its abdominal muscles\n"
            "to forcefully expel swallowed water, then\n"
            "shoot down flying prey. It travels down\n"
            "rivers before evolving. 35/65/35/65/35/65"),
        .pokemonScale = 316,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_RED,
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "It ensnares its foe with its tentacles\n"
            "before delivering the finishing blow.\n"
            "If the foe is too strong, it shoots\n"
            "rocks as it flees. 80/104/80/104/80/32"),
        .pokemonScale = 296,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "is unparalleled. 45/60/30/80/50/65"),
        .pokemonScale = 393,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_HOUNDOOM}),
    },
    [SPECIES_HOUNDOOM] =
    {
        .baseHP        = 75,
        ...
        .description = COMPOUND_STRING(
            ...
            "among themselves. 75/90/50/110/80/95"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Milk used to be dismissed as only for kids\n"
            "until Empress Selene championed its status\n"
            "as nutrient-rich. 105/80/115/70/70/100"),
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "parents' faces. 50/64/50/45/50/41"),
        .pokemonScale = 472,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "colliding with steel. 70/84/70/65/70/51"),
        .pokemonScale = 292,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
