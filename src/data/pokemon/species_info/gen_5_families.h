...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the plant life. 55/63/90/50/80/42"),
        .pokemonScale = 432,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEAVANNY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "using its silk. 75/103/80/70/80/92"),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VENIPEDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It is very aggressive. 30/45/59/30/39/57"),
        .pokemonScale = 491,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WHIRLIPEDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "crashes into foes. 40/55/99/40/79/47"),
        .pokemonScale = 282,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCOLIPEDE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "them off with poison. 80/100/89/50/69/112"),
        .pokemonScale = 257,
        .pokemonOffset = 2,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_COTTONEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_WHIMSICOTT}),
    },
    [SPECIES_WHIMSICOTT] =
    {
        .baseHP        = 60,
    ...
    [SPECIES_KROKOROK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "clearly at night. 60/82/45/45/45/73"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_KROOKODILE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "an automobile. 95/117/80/65/70/103"),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLITE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "is treasured by many. 36/44/50/65/60/50"),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It makes snowstorms. 71/79/85/110/95/95"),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_JOLTIK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_SWARM, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "powerful zaps. 35/50/30/50/40/60"),
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_EELEKTROSS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "their sucker mouths. 85/115/80/115/80/50"),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 365,
        .trainerOffset = 7,
    ...
    [SPECIES_LITWICK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that it burns. 50/30/55/65/55/20"),
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHANDELURE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "hypnotizes foes. 75/55/90/145/90/80"),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_HAXORUS] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "steel beams. 76/147/90/60/70/97"),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its six wings. The heads on their arms\n"
