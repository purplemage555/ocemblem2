...
const u8 gText_Badges[] = _("Stamps"); // Unused
...
const u8 gText_SizeComparedTo[] = _("Not to Scale ");
...
const u8 gText_DexHoennTitle[] = _("Selenian Dex");
const u8 gText_DexNatTitle[] = _("World Dex");
...
const u8 gText_DexHoennDescription[] = _("Selenia's Pokédex");
const u8 gText_DexNatDescription[] = _("International Pokédex");
...
const u8 gText_DadsAdvice[] = _("Now isn't the time to use that!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TurnedOverVar1ForVar2[] = _("{PLAYER} sold {STR_VAR_2}\nfor ¥{STR_VAR_1}.");
...
const u8 gText_ExpPoints[] = _("Experience");
...
const u8 gText_TurnOff[] = _("Shut Down");
...
const u8 gText_Ok3[] = _("Okay"); // Unused
...
const u8 gText_FreshWaterAndPrice[] = _("Fresh Water{CLEAR_TO 0x48}¥250");
...
const u8 gText_DexHoenn[] = _("Selenia");
const u8 gText_DexNational[] = _("World");
...
const u8 gText_Hoenn[] = _("Selenia");
...
const u8 gText_MicrowaveOven[] = _("Microwave");
