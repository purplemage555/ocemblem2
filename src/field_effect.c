...
static const u32 sNewGameBirch_Gfx[] = INCBIN_U32("graphics/birch_speech/maple.4bpp");
static const u16 sNewGameBirch_Pal[16] = INCBIN_U16("graphics/birch_speech/maple.gbapal");
