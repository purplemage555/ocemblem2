...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_METEOR_FALLS2},
...
static const u8 sMapHealLocations[][3] =
{
	...
	[MAPSEC_PALLET_TOWN] = {MAP_GROUP(EASTFORD_OW), MAP_NUM(EASTFORD_OW), HEAL_LOCATION_EASTFORD},
	[MAPSEC_VIRIDIAN_CITY] = {MAP_GROUP(KIRKOPOLIS_OW), MAP_NUM(KIRKOPOLIS_OW), HEAL_LOCATION_KIRKOPOLIS},
	[MAPSEC_PEWTER_CITY] = {MAP_GROUP(PETESBURG_OW), MAP_NUM(PETESBURG_OW), HEAL_LOCATION_PETESBURG},
	[MAPSEC_CERULEAN_CITY] = {MAP_GROUP(SANCTUM_OW), MAP_NUM(SANCTUM_OW), HEAL_LOCATION_SANCTUM},
	[MAPSEC_VERMILION_CITY] = {MAP_GROUP(SOUTHPORT_OW), MAP_NUM(SOUTHPORT_OW), HEAL_LOCATION_SOUTHPORT},
	[MAPSEC_MT_MOON] = {MAP_GROUP(ALIEN_CRASH_SITE), MAP_NUM(ALIEN_CRASH_SITE), HEAL_LOCATION_CRASHSITE},
	[MAPSEC_SAFFRON_CITY] = {MAP_GROUP(NOVEMBURG_OW), MAP_NUM(NOVEMBURG_OW), HEAL_LOCATION_NOVEMBURG},
	[MAPSEC_CINNABAR_ISLAND] = {MAP_GROUP(NEW_EBONHEART_OW), MAP_NUM(NEW_EBONHEART_OW), HEAL_LOCATION_EBONHEART},
	[MAPSEC_FUCHSIA_CITY] = {MAP_GROUP(AGRIOPOLIS_OW), MAP_NUM(AGRIOPOLIS_OW), HEAL_LOCATION_AGRIOPOLIS},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_PALLET_TOWN:
        return FlagGet(FLAG_VISITED_EASTFORD) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VIRIDIAN_CITY:
        return FlagGet(FLAG_VISITED_KIRKOPOLIS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PEWTER_CITY:
        return FlagGet(FLAG_VISITED_PETESBURG) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CERULEAN_CITY:
        return FlagGet(FLAG_VISITED_SANCTUM) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VERMILION_CITY:
        return FlagGet(FLAG_VISITED_SOUTHPORT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MT_MOON:
        return FlagGet(FLAG_VISITED_ACS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SAFFRON_CITY:
        return FlagGet(FLAG_VISITED_NOVEMBURG) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CINNABAR_ISLAND:
        return FlagGet(FLAG_VISITED_EBONHEART) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FUCHSIA_CITY:
        return FlagGet(FLAG_VISITED_AGRIOPOLIS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_10_POKECENTER:
        return FlagGet(FLAG_VISITED_MAPLEGROVE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CELADON_CITY:
        return FlagGet(FLAG_VISITED_DAWNSTAR) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROCKET_HIDEOUT:
        return FlagGet(FLAG_VISITED_FOREVER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LAVENDER_TOWN:
        return FlagGet(FLAG_VISITED_DUSKSTONE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ROUTE_4_POKECENTER:
        return FlagGet(FLAG_VISITED_BRIDGEKEEP) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CAPE_BRINK:
        return FlagGet(FLAG_VISITED_RADIO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_INDIGO_PLATEAU:
        return FlagGet(FLAG_VISITED_SELENIUM) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
