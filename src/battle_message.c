...
static const u8 sText_Trainer1WantsToBattle[] = _("{B_TRAINER1_NAME_WITH_CLASS} wants to battle!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNHURTBYPOISON]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was hurt by poison!"),
    ...
    [STRINGID_PKMNMADEITRAIN]                       = COMPOUND_STRING("It started to rain!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXINTENSIFIEDSUN]                 = COMPOUND_STRING("The sunlight turned harsh!"), //not in gen 5+, ability popup
    ...
    [STRINGID_STARTEDSNOW]                          = COMPOUND_STRING("It started snowing!"),
    ...
    [STRINGID_SNOWWARNINGSNOW]                      = COMPOUND_STRING("It started snowing!"),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_VOLCANIC_ASH]       = STRINGID_SANDSTORMISRAGING,
...
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_NAME_WITH_CLASS} and {B_TRAINER2_NAME_WITH_CLASS} want to battle!\p");
