...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("Forever Kn."), 8 },
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Elite Knight"), 10 },
    ...
    [TRAINER_CLASS_NINJA_BOY] = { _("Ninja"), 3, BALL_DUSK },
    ...
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("Forever Lord"), 10 },
	...
	[TRAINER_CLASS_SCIENTIST] = { _("Scientist"), BALL_REPEAT },
	[TRAINER_CLASS_ENGINEER] = { _("Engineer"), BALL_REPEAT },
};
