...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("Forever Kn.") },
    ...
    [TRAINER_CLASS_HEX_MANIAC] = { _("Sorcerer"), 12 },
    [TRAINER_CLASS_AROMA_LADY] = { _("Alchemist"), 12 },
    ...
    [TRAINER_CLASS_FISHERMAN] = { _("Fisherman"), 10, BALL_NET },
